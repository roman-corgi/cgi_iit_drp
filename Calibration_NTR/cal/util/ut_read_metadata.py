...
from .read_metadata import Metadata, ReadMetadataException
...
meta_path_test = Path(here, 'metadata_test.yaml')
# Read yaml
...
class TestMetadata(unittest.TestCase):
    ...
    def test_attributes(self):
        ...
        self.assertEqual(meta.frame_rows, meta.data['frame_rows'])
        self.assertEqual(meta.frame_cols, meta.data['frame_cols'])
        self.assertEqual(meta.geom, meta.data['geom'])
