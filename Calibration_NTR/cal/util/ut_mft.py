...
from .mft import do_mft, do_offcenter_mft, do_imft, _interval
from .insertinto import insertinto
from .fresnelprop import do_fft
...
class TestDoMFT_IMFT(unittest.TestCase):
    ...
    def test_mft_vs_fft(self):
        ...
        e_mft = do_mft(e, outshape, pixperlod, pixperpupil)
        e_fft = insertinto(do_fft(insertinto(e,
    ...
    def test_zero_pad_mft_input(self):
        ...
        scale = 2
        e2 = insertinto(self.e, (scale*self.pixperpupil,
    ...
    def test_zero_pad_imft_output(self):
        ...
        out2crop = insertinto(out2, self.outshape)
...
class TestDoOffcenterMFT(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.efull = np.roll(
            insertinto(self.e, self.pupilShape),
